...
% MODIFICARE
%semnal sinusoidal de 5000Hz
test_dur = 4;
test_fs = 45000; 
test_time = (0 : (1 / test_fs) : test_dur)';
sinus = sin(2 * pi * 5000 * test_time);
test_window_size = 512;
[S, f, t] = spectrogram(sinus, test_fs, test_window_size);
plot_spectrogram(S, f, t, "semnal sinusoidal 5000");
